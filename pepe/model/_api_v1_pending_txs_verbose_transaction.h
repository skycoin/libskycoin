/*
 * _api_v1_pending_txs_verbose_transaction.h
 *
 * 
 */

#ifndef __api_v1_pending_txs_verbose_transaction_H_
#define __api_v1_pending_txs_verbose_transaction_H_
...
typedef struct _api_v1_pending_txs_verbose_transaction_t {
    long length; //numeric
    long type; //numeric
    char *txid; // string
...
} _api_v1_pending_txs_verbose_transaction_t;
...
#endif /* __api_v1_pending_txs_verbose_transaction_H_ */
