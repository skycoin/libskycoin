...
install-lib-curl: ## Install Sky Api curl based rest wrapper
	(cd lib/curl && mkdir -p build && cd build && cmake .. && make && sudo make install &&cd ../..)
