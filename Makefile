...
swagger-client: ## Generate C client for accessing Skycoin REST API
	@rm -rf $(SWAGGER_CLIENT_DIR)/cClient
	@openapi-generator generate -g c --additional-properties=prependFormOrBodyParameters=true -o $(SWAGGER_CLIENT_DIR)/cClient -i ./lib/swagger/swagger.yml
