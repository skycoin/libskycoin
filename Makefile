...
swagger2: install-deps-swagger ## Generate swagger 2.0 specification for Skycoin API
	...
	-swagger generate spec -b github.com/skycoin/skycoin/src/api -o $(LIBSRC_ABS_PATH)/$(SWAGGER_SPEC_DIR)/skycoin.v0.25.1.openapi.v2.json
	-swagger generate spec -b github.com/skycoin/skycoin/src/api -o $(LIBSRC_ABS_PATH)/$(SWAGGER_SPEC_DIR)/skycoin.v0.25.1.openapi.v2.yml
