...
generate-swagger-spec: ## Generate swagger 2.0 specification for Skycoin Api
	@rm -rf ./lib/swagger/swagger.yml
	@rm -rf ./lib/swagger/swagger.json
	...
	@mv -n ./swagger.yml ./lib/swagger
	@mv -n ./swagger.json ./lib/swagger
...
check-swagger: generate-swagger-spec ## Validate the specification generated by go-swagger against swagger 2.0 specification
	@echo "Start swagger validation."
	-swagger validate ./lib/swagger/swagger.yml
	-swagger validate ./lib/swagger/swagger.json
...
check: lint test-libc check-swagger ## Run tests and linters
