...
void apiv1pending_txs_transaction_free(apiv1pending_txs_transaction_t *apiv1pending_txs_transaction) {
    ...
    free(apiv1pending_txs_transaction->hash);
...
cJSON *apiv1pending_txs_transaction_convertToJSON(apiv1pending_txs_transaction_t *apiv1pending_txs_transaction) {
	...
	// apiv1pending_txs_transaction->fee
    if(cJSON_AddNumberToObject(item, "fee", apiv1pending_txs_transaction->fee) == NULL) {
    goto fail; //Numeric
    }
	...
	// apiv1pending_txs_transaction->hash
    if(cJSON_AddStringToObject(item, "hash", apiv1pending_txs_transaction->hash) == NULL) {
    goto fail; //String
    }
...
apiv1pending_txs_transaction_t *apiv1pending_txs_transaction_parseFromJSON(char *jsonString){
    ...
    // apiv1pending_txs_transaction->fee
    cJSON *fee = cJSON_GetObjectItemCaseSensitive(apiv1pending_txs_transactionJSON, "fee");
    ...
    // apiv1pending_txs_transaction->hash
    cJSON *hash = cJSON_GetObjectItemCaseSensitive(apiv1pending_txs_transactionJSON, "hash");
