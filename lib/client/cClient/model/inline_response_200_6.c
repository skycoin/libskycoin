...
inline_response_200_6_t *inline_response_200_6_create(
	...
	inline_response_200_6->entries = entries;
	inline_response_200_6->meta = meta;
...
void inline_response_200_6_free(inline_response_200_6_t *inline_response_200_6) {
    listEntry_t *listEntry;
		list_ForEach(listEntry, inline_response_200_6->entries) {
		apiv1wallets_entries_free(listEntry->data);
	}
	list_free(inline_response_200_6->entries);
	apiv1wallets_meta_free(inline_response_200_6->meta);
...
cJSON *inline_response_200_6_convertToJSON(inline_response_200_6_t *inline_response_200_6) {
	...
	list_ForEach(entriesListEntry, inline_response_200_6->entries) {
	...
	// inline_response_200_6->meta
	cJSON *meta = apiv1wallets_meta_convertToJSON(inline_response_200_6->meta);
	if(meta == NULL) {
...
inline_response_200_6_t *inline_response_200_6_parseFromJSON(char *jsonString){
    ...
    // inline_response_200_6->entries
    cJSON *entries;
    cJSON *entriesJSON = cJSON_GetObjectItemCaseSensitive(inline_response_200_6JSON,"entries");
    ...
    // inline_response_200_6->meta
    apiv1wallets_meta_t *meta;
    cJSON *metaJSON = cJSON_GetObjectItemCaseSensitive(inline_response_200_6JSON, "meta");
    if(inline_response_200_6JSON == NULL){
        const char *error_ptr = cJSON_GetErrorPtr();
        if (error_ptr != NULL)
            fprintf(stderr, "Error Before: %s\n", error_ptr);
