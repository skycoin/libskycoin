...
module SwaggerClient
  ...
  class InlineResponse2002Blockchain
    attr_accessor :head

    attr_accessor :time_since_last_block
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'time_since_last_block')
        self.time_since_last_block = attributes[:'time_since_last_block']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          head == o.head &&
          time_since_last_block == o.time_since_last_block &&
    ...
    def hash
      [head, time_since_last_block, unconfirmed, unspents].hash
    end
