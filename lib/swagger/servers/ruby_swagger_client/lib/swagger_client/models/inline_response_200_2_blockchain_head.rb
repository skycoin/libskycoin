...
module SwaggerClient
  ...
  class InlineResponse2002BlockchainHead
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'block_hash')
      ...
      if attributes.has_key?(:'previous_block_hash')
      ...
      if attributes.has_key?(:'tx_body_hash')
        self.tx_body_hash = attributes[:'tx_body_hash']
      end

      if attributes.has_key?(:'ux_hash')
    ...
    def hash
      [block_hash, fee, previous_block_hash, seq, timestamp, tx_body_hash, ux_hash, version].hash
    end
