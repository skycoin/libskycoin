...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WalletMeta :  IEquatable<WalletMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletMeta" /> class.
        /// </summary>
        ...
        public WalletMeta(string Coin = default(string), string CryptoType = default(string), bool? Encrypted = default(bool?), string Filename = default(string), string Label = default(string), long? Timestamp = default(long?), string Type = default(string), string Version = default(string))
        {
            this.Coin = Coin;
        ...
        {
            return this.Equals(input as WalletMeta);
        }

        /// <summary>
        /// Returns true if WalletMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of WalletMeta to be compared</param>
        /// <returns>Boolean</returns>
